...
if [ "$1" != gameonly ]; then
    gcc code/wayland_handmade.cpp "$WAYLAND_PROT_C" -include "$WAYLAND_PROT_H" -lwayland-client -lwayland-egl -lEGL -lGLESv2 -lm -g -Wall $WARNING_FLAGS -Werror -Wunused-label -o build/wayland_handmade
fi;
